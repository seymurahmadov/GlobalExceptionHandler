package com.example.exceptionhandler.aspect;
...
public class ServiceAspect {
    ...
    @Before("execution(* com.example.exceptionhandler.service.ProductService.*(..))")
    ...
    @After("execution(* com.example.exceptionhandler.service.ProductService.*(..))")
    ...
    @AfterReturning("execution(* com.example.exceptionhandler.service.ProductService.*(..))")
    ...
    @Pointcut("execution(* com.example.exceptionhandler.service.ProductService.*(..))")
    ...
    @Around("execution(* com.example.exceptionhandler.service.ProductService.*(..))")
